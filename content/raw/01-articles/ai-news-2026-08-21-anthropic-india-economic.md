---
title: "Anthropic 经济指数印度简报：全球第二大 Claude 使用国，人均排名仅第 101"
type: article
tags: [anthropic, economics, india, research]
source_url: https://www.anthropic.com/research/india-brief-economic-index
ingested: 2026-08-21
sha256: c767a0a1e7647e1b3d8232406289d2f4f8824bd1a30bf97db711bffeb6af87c0
summary: "Anthropic 经济指数印度国别简报（2026-02 发布、8 月重上 HN）：印度占全球 Claude.ai 使用量 5.8%（仅次于美国），但人均排名 101/116；45.2% 任务为软件相关（全球第一），AI 带来 15 倍加速（高于全球 12 倍），用户更愿授予 AI 自主权。"
---

# Anthropic 经济指数印度简报：全球第二大 Claude 使用国，人均排名仅第 101

> 原文：https://www.anthropic.com/research/india-brief-economic-index（ingested 2026-08-21）
...
In this post, we share two results that show how Claude can help life scientists increase the pace of their research. In the first, we tested Claude’s ability to design protein binders from scratch, a key step in creating protein-based drugs that has historically taken a specialist weeks or months per target. In the second example, we evaluated whether Claude can accelerate chemical analysis. Claude Opus 5, a generally available model, was given NMR and LC-MS data (the data that allows chemists to assess the identity and purity of the compounds they work with). Read more
Patterns and problems in emerging multiagent systems
Here, we identify a few examples of behavioral tendencies in current frontier models and show how they can produce unexpected systemic failures, in hopes of starting a conversation about mitigating these risks. Read more
Reviewing the evidence on worker retraining programs
We're sharing a review of the evidence on worker retraining programs, coauthored by independent researcher David Roodman and Anthropic's Maxim Massenkoff. Read more

---
title: "Netic：用单个开源 LLM 替换 223 节点智能体图，语音 agent 预定转化率 +15 点"
type: article
...
ingested: 2026-08-22
sha256: 2dcc046279419f1e4b07c5afb7ed5835d33ff43134a848d07ebc577a2e7bfe92
summary: "Netic 工程复盘：用单个开源权重模型（Kimi K2.6 / GLM 5.2）+ 全量上下文 + 工具边界约束，替换 223 节点 646 边的对话图编排，containment 与预定率各 +15 点、TTFT 减半至约 500ms，累计为客户完成超 5 亿美元自主预约。"
---

# Netic：用单个开源 LLM 替换 223 节点智能体图，语音 agent 预定转化率 +15 点

> 原文：https://www.netic.ai/blog/replacing-node-agent-graph-with-open-source-llm（ingested 2026-08-22）
...
Looking Ahead
We're super excited about the capabilities of flagship models and their ability to handle long-running tasks. We fully believe that giving an LLM the context it needs and verifying what it does is enough in 2026 to hold the principles above without the structure that used to hold them. As they get better and better, we will further be able to remove even more abstractions that fill in their remaining capability gaps.
‍

...
GLM 系列最新旗舰推理模型，由 [[ZAI]] 于 2026 年 8 月 18 日发布（max 版本），纯文本输入/输出的闭源模型，1M token 上下文。

## 关键信息

- **智能水平**：Artificial Analysis 智能指数 60 分，181 个模型中位列第 8；同类价格档位中位仅 35 分，大幅领先。
- **规格**：推理模型（reasoning）；仅文本模态，非多模态；1M token 上下文窗口。
